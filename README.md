...
النسخة الحالية (1.0) تتضمن المزايا الأساسية للنظام:
- إدارة كاملة للوكلاء والسبوكلاء والعملاء
- إدارة الخدمات والطلبات
- نظام عروض الأسعار
...
نعمل حالياً على تطوير النسخة 2.0 التي ستشمل:
- تطبيقات جوال للعملاء والسبوكلاء
- نظام دفع إلكتروني متكامل
- ذكاء اصطناعي لتحسين التوصيات والتسعير
- دعم تعدد اللغات الكامل
- تكاملات متقدمة مع الأنظمة الخارجية

لمزيد من التفاصيل حول خطة التطوير، راجع [خريطة طريق النسخة 2.0](/VERSION-2-ROADMAP.md).
...
لبدء العمل على النسخة 2.0، قم بتنفيذ:
...
هذا سينشئ فرعاً جديداً ويعد البنية الأساسية للنسخة 2.0.
