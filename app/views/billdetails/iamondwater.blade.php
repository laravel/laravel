...
@stop
@section('search')
	<form action="/admin/iamondWater" method='get'>
		<table>
			<tr>
				<td>送花人ID</td>
			...
			<tr>	
                ...
                <td>类型:</td>
				<td>
                <select id="flag" name="flag" class="form-control" style="width:130px;">
                	<option value="-1" <?php if($return['flag']==-1){echo "selected";}?> >全部类型</option>
                    <option value="0" <?php if($return['flag']== 0){echo "selected";}?> >送花消费</option>
                    <option value="1" <?php if($return['flag']== 1){echo "selected";}?> >下载作品消费</option>
                    <option value="2" <?php if($return['flag']== 2){echo "selected";}?> >鲜花兑换的钻石</option>
                    <option value="3" <?php if($return['flag']== 3){echo "selected";}?> >自己现金购买的钻石</option>
                    <option value="4" <?php if($return['flag']== 4){echo "selected";}?> >兑换商品赠送钻石</option>
                    <option value="5" <?php if($return['flag']== 5){echo "selected";}?> >购买商品赠送钻石</option>
                </select>
                </td>
				<td colspan=2>
