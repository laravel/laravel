...
@section('content')
	<table class="table table-hover table-bordered ">
		...
		<tr>
			...
			<td><button class="operator btn btn-mini btn-danger" type="button"  value='{{$item['id']}}|{{$item['uid']}}'>删除作品</button>
