  ...
  <meta name="viewport" content="width=device-width,maximum-scale=1, user-scalable=no, minimal-ui">
    ...
    <style>
        *{ padding:0; margin:0;}
        ...
        .textC{font-size:1.25em; color:#6E6E6E; padding-top:4px;}
        .clear{ clear:both;}
    ...
    <div style=" border-top:1px solid  #CCC; margin:0px 3%; padding-top:2%; position:relative;">
        <ul class="contentUl">
            <li style="margin-top:5px;">
                <img style="width:80px;height:80px" src="../../img/icon-72.png" alt="" width="79%">
            </li>
            <li style="text-align:left; margin-left:15px;">
                ...
                <p class="textC" style="border:1px #FFF solid; width:100%; clear:both;">
                诵读导师：{{$list['readername']}}&nbsp;
                    <!--性别图片-->
                    @if($list['sex'] == 2)
                ...
                <!--p style="margin:3% 0 1% 0;">
                    ...
                    <span id="text-time">{{$list['duration']}}</span>
                </p-->
                <p style="margin:4px 0px 0px 0px;">
                    <img src="../../img/downnum.png" alt="" width="15" height="14"/>
                    <span id="text-hear">{{$list['downnum']}}</span>&nbsp;&nbsp;&nbsp;
                </p>
            </li>
        </ul>
        ...
        <div style="position:absolute; right:15px; top:23px; z-index:1;">
            ...
            <input type="hidden" name="opusUrl" id="opusUrl" value='{{$list['yurl']}}' /> 
        </div> 
        <div class="clear"></div> 
    </div>
