		...
		<div id="jp_container_1">
			<div class='portrait'>
				<div style="position:absolute; z-index:1;">
                	<span class="icon"  style=" position:absolute; z-index:2;right:0px;bottom:0px;">
                        @if($list['isleague'] == 1)
                            <img src="{{$poem_url.'/upload/img/sharev2/bird.png'}}"/>
                        @elseif($list['authtype'] == 1)
                            <img  src="{{$poem_url.'/img/sharev2/v.png'}}"/>
                        @elseif($list['teenager'] == 1)
                            <img src="{{$poem_url.'/img/sharev2/child.png'}}"/>
                        @endif
                    </span>
                    <img src="{{$list['sportrait']}}" width="230" height="230" border="0">
                </div>
                <div class="play">
					<a href="#" class="jp-play"><img id="play" src="{{$poem_url.'/upload/img/sharev2/play.png'}}" style="width:55px;height:55px;margin-top:165px" border="0"/></a>
					<a href="#" class="jp-pause"><img id="play" src="{{$poem_url.'/upload/img/sharev2/pause.png'}}" style="width:55px;height:55px;margin-top:165px" border="0"/></a>
				</div>
			...
			<div class="poem_info">
				<span class="poem_title"><?php if(mb_strlen($list['name'])>15){ echo mb_substr($list['name'],0,15,'utf8').'...';}else {echo $list['name'];}?></span>
				<span class="poem_user">主播：{{$list['nick']}}</span>
				<div class="mark_line">
				</div>
