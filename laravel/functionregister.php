...
use Closure, Exception, Laravel;
use \BadFunctionCallException, \OutOfBoundsException;
...
class FunctionRegister
{
	...
	{
		if( ! array_key_exists($name, static::helpers()) )
			throw new BadFunctionCallException('Inexistant Helper : ' . $name . '.');
	...
	{
		return array_key_exists($name, static::helpers()) ? static::$_helpers[$name] : null;
	}

	public static function register($name, Closure $func, $override = false)
	{
		if( array_key_exists($name, static::helpers()) and ! $override )
			throw new InvalidArgumentException('Helper with name "' . $name . '" already exists.');

		static::$_helpers[$name] = $func;
	}

	public static function deregister($name)
	{
		if( ! array_key_exists($name, static::helpers()) )
			throw new OutOfBoundsException('Helper with name "' . $name . '" does not exist.');

		unset(static::$_helpers[$name]);
	}

	public static function override($name, Closure $func)
	{
		static::register($name, $func, true);
	}
	
	protected static function init()
	{
		if(static::$_initialized === true)
			return;
		...
		static::$_helpers = array(
			 ...
			 * @return string
			 */
			'__' => function($key, $replacements = array(), $language = null) {
			 ...
			 * @return void
			 */
			'array_forget' => function(&$array, $key) {
				$keys = explode('.', $key);
			 ...
			 * @return mixed
			 */
			'array_first' => function($array, $callback, $default = null) {
			 ...
			 * @return array
			 */
			'array_strip_slashes' => function($array) {
				$result = array();
			 ...
			 * @return array
			 */
			'array_pluck' => function($array, $key) {
			 ...
			 * @return array
			 */
			'array_only' => function($array, $keys) {
			 ...
			 * @return object
			 */
			'eloquent_to_json' => function($models) {
			 ...
			 * @return string
			 */
			 'asset' => function($url, $https = false) {
			 ...
			 * @return string
			 */
			'action' => function($action, $parameters = array()) {
			 ...
			 * @return string
			 */
			'route' => function($name, $parameters = array()) {
			 ...
			 * @return string
			 */
			'root_namespace' => function($class, $separator = '\\') {
			 ...
			 * @return string
			 */
			'render_each' => function($partial, array $data, $iterator, $empty = 'raw|') {
			 ...
			 * @return string
			 */
			'get_cli_option' => function($option, $default = null)
			{
