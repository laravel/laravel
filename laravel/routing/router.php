...
class Router {
	...
	{
		static::controller($controllers, $defaults, $route, true);
	}
	 ...
	 * @return void
	 */
	public static function controller($controllers, $defaults = 'index', $route = '(:root)/(:controller)/(:wildcards)', $https = false)
	{
