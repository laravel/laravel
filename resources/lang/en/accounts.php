...
return [
    ...
    'verification' => [
        'email_sent' => 'If your email address exists in our database, you will receive a verify link at your email address in a few minutes.',
        'email_resend' => 'Resend verify link',
