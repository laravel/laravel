...
<div class="container-main">
    <div class="row">
        ...
        <div class="col-4-main" style="min-height: 100vh;">
            ...
            <img src="{{asset('assets/img/logo.gif')}}" alt="Company Logo" height="50"> <!-- Replace "logo.png" with your logo path -->
            </header>
            <div class="container">
                    <form method="POST" action="{{ route('password.update') }}">
                        ...
                        <div class="form-group row" style="display:block;">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ $email ?? old('email') }}" required autocomplete="email" autofocus placeholder="Registered Email">
                        ...
                        <div class="form-group row" style="display:block; margin-top: 20px">
                        ...
                        <div class="form-group row" style="display:block; margin-top: 20px">
                            ...
                            <div class="col-md-6" style="position:relative;">
                                <input id="password-confirm" type="password" class="form-control" name="password_confirmation" required autocomplete="new-password" placeholder="Confirm the New Password" style="width: 100%; background: none;">
                                <span class="toggle-password-2" style="display: inline;position: absolute;right: 0;bottom: 10px;">
                                    <img src="{{asset('assets/img/eye.png')}}" alt="" width="20px" height="auto" style="filter:invert(1);">
                                </span>
                            </div>
                        </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        const togglePassword = document.querySelector('.toggle-password-2');
