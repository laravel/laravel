...
<link rel="stylesheet" href="{{ mix($stylesheet) }}">

<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:title" content="{{ $page['share_title'] ?? null }}">
<meta name="twitter:site" content="{{ $page['site_twitter_handle'] ?? null }}">
<meta name="twitter:image:src" content="{{ $page['social_image'] ?? null }}">
<meta name="twitter:description" content="{{ $page['share_description'] ?? null }}">
<meta name="twitter:creator" content="{{ $page['creator_twitter_handle'] ?? null }}">

<meta property="og:title" content="{{ $page['share_title'] ?? null }}">
...
<meta property="og:description" content="{{ $page['share_description'] ?? null }}">
