...
<div class="card">
    <div class="card-header">
        <i class="bi bi-plus-circle me-2"></i>Form Tambah Jenis Cuti
    </div>
    <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <input type="number" name="max_hari" class="form-control @error('max_hari') is-invalid @enderror" value="{{ old('max_hari', 12) }}" min="1" required>
                        @error('max_hari')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
