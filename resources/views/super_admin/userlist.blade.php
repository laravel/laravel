...
<style>
    ...
    .userlist-superadmin-table-profile table{
        width: 100%;
        border: 2px solid black;
    }
    .userlist-superadmin-table-profile table th{
        border: 2px solid black;
    ...
    .userlist-superadmin-table-profile table td{
        border: 2px solid black;
        color: black;
        font-size: 16px;
        text-align: center;
  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-white" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-dark active bg-gradient-primary" href="http://127.0.0.1:8000/super_admin/userlist">
            <div class="text-dark text-center me-2 d-flex align-items-center justify-content-center">
    ...
    <div class="container-fluid px-2 px-md-4 super_admin_dashboard">
      ...
      <div class="card card-body mt-4">
        <div class="row">
          ...
          <div class="userlist-superadmin-table-profile">
