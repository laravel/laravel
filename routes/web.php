...
Route::middleware(['auth','active'])->group(function(){Route::post('/logout',[AuthController::class,'logout'])->name('logout');Route::get('/dashboard',DashboardController::class)->name('dashboard');
 ...
 Route::get('/deliveries',[OperationsController::class,'deliveries']);Route::get('/delivery-change-requests',[OperationsController::class,'deliveryChanges']);Route::post('/delivery-change-requests/{change}',[OperationsController::class,'reviewDeliveryChange']);
 Route::get('/invoices',[OperationsController::class,'invoices']);Route::get('/invoices/{invoice}/pdf',[FinanceController::class,'invoicePdf']);Route::get('/payments',[OperationsController::class,'payments']);Route::get('/receipts/{receipt}/pdf',[FinanceController::class,'receipt']);Route::get('/balances',[OperationsController::class,'balances']);
 Route::get('/cash-handovers',[OperationsController::class,'handovers']);Route::post('/cash-handovers/{handover}/verify',[OperationsController::class,'verifyHandover']);
 Route::get('/daily-closings',[OperationsController::class,'closings']);Route::get('/payment-corrections',[OperationsController::class,'corrections']);Route::post('/payment-corrections/{correction}',[OperationsController::class,'reviewCorrection']);
 Route::get('/notifications',[OperationsController::class,'notifications']);Route::get('/audit-log',[OperationsController::class,'audit']);Route::get('/devices',[OperationsController::class,'devices']);Route::get('/reports',[OperationsController::class,'reports']);Route::get('/reports/{report}/{format}',[ReportController::class,'export']);Route::get('/settings',[OperationsController::class,'settings']);Route::put('/settings',[OperationsController::class,'updateSettings']);
});
