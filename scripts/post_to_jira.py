                ...
                "content": [
                    {
                        "type": "paragraph",
                        "content": [
                            {"type": "text", "text": "TEST MODE - AI Pipeline Simulation"},
                        ],
                    },
                    {
                        "type": "paragraph",
                        "content": [
                            {"type": "text", "text": "Simulated AI PR link: "},
                            {
                                "type": "text",
                                "text": "https://dummy-pr-link.example.com",
                                "marks": [{"type": "link", "attrs": {"href": "https://dummy-pr-link.example.com"}}],
                            },
                        ],
                    },
                    {
                        "type": "paragraph",
                        "content": [
                            {"type": "text", "text": "Simulated branch: feature/test-ai"},
                        ],
                    },
                    {
                        "type": "paragraph",
                        "content": [
                            {"type": "text", "text": "Generated by: Dummy AI pipeline"},
                        ],
                    },
                ],
            }
